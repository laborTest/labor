...
public class Bip {
    ...
    private String bipTLowersecurity="0";

    private String bipTCriminal="0";

    private String bipTDestitute="0";

    private String bipTPeasant="0";

    private String bipTVeteran="0";

    private String bipTOthercities="0";

    private String bipTCzjyyhz="0";

    private String bipTRhfl="0";

    private String bipTNewgraduate="0";
